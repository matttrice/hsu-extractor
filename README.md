...
3. **Hyperlinks**: When an element has a `hyperlink` with `type: "customshow"`:
   - Display the `linked_content.slides` as a modal/overlay
   - After viewing, return to the main slide
...
2. Click → Show "Genesis 12:1-3" (clickable - links to scripture)
3. Click → Show "Great Nation"
4. Click → Show "Land of Canaan"
5. ... continue through sequence
6. When user clicks "Genesis 12:1-3", show the linked Genesis 12:1-3 scripture content
7. After all 35 items revealed, next click advances to slide 2